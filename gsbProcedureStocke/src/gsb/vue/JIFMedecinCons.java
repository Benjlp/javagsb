...
public class JIFMedecinCons extends JIFMedecin  implements ActionListener {
    ...
    public JIFMedecinCons() {
        ...
        retraite = new JButton("retraite");
        pBoutons.add(retraite);
        ...
        retraite.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent evt) { 
		Object source = evt.getSource();
   		if (source == premier){
				...
				Medecin leMedecin = lesMedecins.get(indiceEnCours);
		    	remplirText(leMedecin);		    	}
		 else if (source == retraite) {
			MedecinDao.Retraiter(lesMedecins.get(indiceEnCours).getCodeMed());
			}
 } // fin actionPerformed
